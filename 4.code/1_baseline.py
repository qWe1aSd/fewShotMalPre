#!/usr/bin/env python
# encoding: utf-8
# @time: 2023/1/17 16:57
# @author: Bai (๑•̀ㅂ•́)و✧
# @file: 3_baseline.py
# @software: PyCharm

"""
    Baseline，drebin/androzoo * all/part，all feature，rf
        - drebin_part (1512, 223)/(195, 223), features all 221
        - drebin_all (5109, 223)/(195, 223), features all 221
        - androzoo_part (1472, 223)/(198, 223), features all 221
        - androzoo_all (5255, 223)/(198, 223), features all 221

    path in: 'F:/12.soj_few_shot/3_baseline/*/feature'
             'F:/12.soj_few_shot/3_baseline/*/train'
             'F:/12.soj_few_shot/3_baseline/*/test'
    path out: 'F:/12.soj_few_shot/3_baseline/*/result'
...
if __name__ == '__main__':
    # drebin_part (1512, 223)/(195, 223), features all 221
    path_in = 'F:/12.soj_few_shot/3_baseline/drebin_part/'
    ...
    # drebin_all (5109, 223)/(195, 223), features all 221
    # path_in = 'F:/12.soj_few_shot/3_baseline/drebin_all/'
    # path_feature_in = os.path.join(path_in, 'feature/5_drebin_MI.csv')
    # paths_train_in = [os.path.join(path_in, 'train/train_all_{}.csv'.format(_)) for _ in range(10)]
    # paths_test_in = [os.path.join(path_in, 'test/test_all_{}.csv'.format(_)) for _ in range(10)]
    # path_out = os.path.join(path_in, 'result/all_')
    # paths_result_out = [os.path.join(path_in, 'result/all_result_{}.txt'.format(_)) for _ in range(10)]
    ...
    # androzoo_part (1472, 223)/(198, 223), features all 221
    # path_in = 'F:/12.soj_few_shot/3_baseline/androzoo_part/'
    ...
    # androzoo_all (5255, 223)/(198, 223), features all 221
    # path_in = 'F:/12.soj_few_shot/3_baseline/androzoo_all/'
    # path_feature_in = os.path.join(path_in, 'feature/5_androzoo_MI.csv')
    # paths_train_in = [os.path.join(path_in, 'train/train_all_{}.csv'.format(_)) for _ in range(10)]
    # paths_test_in = [os.path.join(path_in, 'test/test_all_{}.csv'.format(_)) for _ in range(10)]
    # path_out = os.path.join(path_in, 'result/all_')
