#!/usr/bin/env python
# encoding: utf-8
# @time: 2023/1/23 20:19
# @author: Bai (๑•̀ㅂ•́)و✧
# @file: 12_smote.py
# @software: PyCharm

"""
    smote，drebin/androzoo * all/part，all feature，rf
        - drebin_part (1512, 223)/(195, 223), features all 221
        - androzoo_part (1472, 223)/(198, 223), features all 221

    ref
        - smote 代码，https://zhuanlan.zhihu.com/p/147562872
        - smote n_neighbors，https://blog.csdn.net/gxbz_572/article/details/126592497

    path in: 'F:/12.soj_few_shot/5_smote/*/feature'
             'F:/12.soj_few_shot/5_smote/*/train'
             'F:/12.soj_few_shot/5_smote/*/test'
    path out: 'F:/12.soj_few_shot/5_smote/*/result'
...
if __name__ == '__main__':
    # drebin_part (1512, 223)/(195, 223), features all 221
    # path_in = 'F:/12.soj_few_shot/5_smote/drebin_part/'
    ...
    # androzoo_part (1472, 223)/(198, 223), features all 221
    path_in = 'F:/12.soj_few_shot/5_smote/androzoo_part/'
    ...
    for index, (path_train_in, path_test_in, path_result_out) in enumerate(
        ...
        x_train, y_train = SMOTE(k_neighbors=1).fit_resample(x_train, y_train)  # smote
