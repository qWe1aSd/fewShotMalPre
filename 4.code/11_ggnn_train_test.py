    ...
    for s in scale:
        for ki in kind:
            for i in range(0, 10):
                ...
                best_val_acc = 0.0
                best_epoch = 0
                output_file = 'output/GGNN/{}_{}/{}/{}_{}_{}.txt'.format(d, ki, s, d, s, i)
                print(output_file)
                ...
                for epoch in range(7200):
                    ...
                    with torch.no_grad():
                        ...
                        print(f"Epoch: {epoch}, test_acc: {acc:.4f}", get_current_time())
                ...
                # get_results(test_data.y.cpu().tolist(), pre.cpu().tolist(), 'GGNN', output_file, num_class)
                # get_false_nagative(test_data.y.cpu().tolist(), pre.cpu().tolist(), output_file)
                print(111)
